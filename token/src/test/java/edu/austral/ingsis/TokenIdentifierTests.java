...
public class TokenIdentifierTests {
  ...
  public void test002_WhenGettersShouldReturnCorrectInfo() {
    TokenIdentifier tokenIdentifier = TokenIdentifier.letTokenIdentifier;
  ...
  public void test003_WhenThePatternMatchesTokenVerifyShouldReturnTrue() {
    final TokenIdentifier t1 = TokenIdentifier.numberLiteralTokenIdentifier;
    final TokenIdentifier t2 = TokenIdentifier.semicolonTokenIdentifier;
    final TokenIdentifier t3 = TokenIdentifier.letTokenIdentifier;
  ...
  public void test004_WhenThePatternDoesNotMatchTokenVerifyShouldReturnFalse() {
    final TokenIdentifier t1 = TokenIdentifier.stringTypeTokenIdentifier;
    final TokenIdentifier t2 = TokenIdentifier.letTokenIdentifier;
    final TokenIdentifier t3 = TokenIdentifier.divOperationTokenIdentifier;
    final String s1 = "/";
    final String s2 = ";";
    final String s3 = "let";
  ...
  public void test005_TokenWrapperGettersShouldWork() {
    final TokenIdentifier variableTokenIdentifier = TokenIdentifier.variableTokenIdentifier;
    final int line = 1;
    final int startPos = 0;
    final int endPos = 3;
    final String value = "asd";
    final Token t = new Token(variableTokenIdentifier, line, startPos, endPos, value);
    Assert.assertEquals(variableTokenIdentifier, t.getToken());
  ...
  public void test008_WhenGetTokenOnTupleShouldReturnIt() {
    final Tuple tuple = new Tuple(TokenIdentifier.letTokenIdentifier, "string");
    Assert.assertEquals(TokenIdentifier.letTokenIdentifier, tuple.getToken());
  }
