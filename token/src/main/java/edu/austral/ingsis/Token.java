...
public class Token {
  ...
  public static Token LET_TOKEN =
      new Token(TokenName.LET, TokenGroup.NOGROUP, Pattern.compile("let"));
  public static Token TYPE_ASSIGNATION_TOKEN =
      new Token(TokenName.TYPE_ASSIGNATION, TokenGroup.NOGROUP, Pattern.compile(":"));
  public static Token SEMICOLON_TOKEN =
      new Token(TokenName.SEMICOLON, TokenGroup.NOGROUP, Pattern.compile(";"));
  public static Token VALUE_ASSIGNATION_TOKEN =
      new Token(TokenName.VALUE_ASSIGNATION, TokenGroup.NOGROUP, Pattern.compile("="));
  public static Token SUM_OPERATION_TOKEN =
      new Token(TokenName.SUM, TokenGroup.OPERATION, Pattern.compile("\\+"));
  public static Token SUB_OPERATION_TOKEN =
      new Token(TokenName.SUB, TokenGroup.OPERATION, Pattern.compile("-"));
  public static Token MULT_OPERATION_TOKEN =
      new Token(TokenName.MULT, TokenGroup.OPERATION, Pattern.compile("\\*"));
  public static Token DIV_OPERATION_TOKEN =
      new Token(TokenName.DIV, TokenGroup.OPERATION, Pattern.compile("/"));
