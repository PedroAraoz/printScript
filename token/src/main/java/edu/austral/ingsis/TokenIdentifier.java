...
public class TokenIdentifier {
  ...
  public static TokenIdentifier IF_TOKEN = new TokenIdentifier(TokenName.IF, Pattern.compile("if"));
  ...
  public static TokenIdentifier BOOLEAN_LITERAL_TOKEN =
      new TokenIdentifier(TokenName.BOOLEAN_LITERAL, Pattern.compile("true|false"));
